...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  methods: {
    fetchPrograms: function () {
      var _fetchPrograms = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return this.$airtable.get("/programs", {
                  params: {
